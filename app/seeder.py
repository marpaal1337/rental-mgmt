...
def seed_database(session: Session, *, clean: bool = False) -> bool:
    ...
    # ── Expenses ────────────────────────────────────────────
    expenses_data = [
        {"property_id": prop1.id, "category": "community", "amount": "85.00",
         "date": date(2026, 1, 5), "deductible": True, "supplier": "Comunidad Gran Vía"},
        {"property_id": prop1.id, "category": "insurance", "amount": "35.50",
         "date": date(2026, 2, 10), "deductible": True, "supplier": "Mapfre"},
        {"property_id": prop1.id, "category": "repairs", "amount": "240.00",
         "date": date(2026, 3, 15), "deductible": True, "supplier": "Fontanero Express"},
        {"property_id": prop1.id, "category": "supplies", "amount": "60.00",
         "date": date(2026, 4, 1), "deductible": False, "supplier": "Iberdrola"},
        {"property_id": prop2.id, "category": "taxes", "amount": "450.00",
         "date": date(2026, 4, 20), "deductible": True, "supplier": "Ayuntamiento Valencia"},
        {"property_id": prop2.id, "category": "admin_fees", "amount": "120.00",
         "date": date(2026, 3, 1), "deductible": True, "supplier": "Gestoría López"},
        {"property_id": prop2.id, "category": "insurance", "amount": "85.00",
         "date": date(2026, 1, 15), "deductible": True, "supplier": "Allianz"},
        {"property_id": prop2.id, "category": "repairs", "amount": "680.00",
         "date": date(2026, 5, 10), "deductible": True, "supplier": "Electricidad Valencia SL"},
    ]
